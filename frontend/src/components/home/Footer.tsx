...
const footerClass =
  "w-screen h-[510px] mt-[268px] bg-[url('./public/images/common/footer.png')] bg-cover flex flex-col justify-end items-center gap-[100px]";
  ...
  return (
    <footer>
      <div className={footerClass}>
        ...
        <div className="flex w-[565px] justify-between mb-10">
          <div>
