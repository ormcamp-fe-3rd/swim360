...
const seedData = async () => {
  try {
    ...
    const users = await User.bulkCreate([
      ...
      { name: '최수종', emailId: 'choi@example.com', phoneNumber: '01087654321', password: '123' },
    ])
    ...
    productData.push(
      {
        brandName: 'Arena',
        name: '누드레이서 라운딩 4부1',
        description: '다이나믹한 수영을 위한 4부 제품입니다. 특수 코팅 처리로 물의 저항을 최소화하였습니다.',
        price: 99000,
        discountedPrice: 89100,
        size: ['S', 'M', 'L', 'XL'],
        imageUrl: [
    ...
    const reviews = await Review.bulkCreate([
      ...
      { content: '만족스러운 구매', imageUrl: 'http://localhost:3000/review-images/reviews1-01.jpg', rating: 4, product_id: 3, user_id: 2 },
      { content: '만족스러운 구매', imageUrl: null, rating: 3, product_id: 3, user_id: 2 },
      { content: '그냥 구매..', imageUrl: null, rating: 2, product_id: 2, user_id: 2 },
      { content: '좋아요', imageUrl: null, rating: 4, product_id: 18, user_id: 2 },
      { content: '좋아요', imageUrl: 'http://localhost:3000/review-images/reviews1-01.jpg', rating: 4, product_id: 20, user_id: 2 },
      { content: '무난템', imageUrl: 'http://localhost:3000/review-images/reviews1-02.jpg', rating: 3, product_id: 20, user_id: 2 },
      { content: '별로에요', imageUrl: null, rating: 1, product_id: 20, user_id: 2 },
      { content: '배송이 빨라요', imageUrl: null, rating: 5, product_id: 30, user_id: 4 },
      { content: '배송이 빨라요', imageUrl: null, rating: 5, product_id: 31, user_id: 4 },
      { content: '무난템', imageUrl: null, rating: 3, product_id: 31, user_id: 4 },
      { content: '너무 좋아요!!', imageUrl: null, rating: 4, product_id: 50, user_id: 4 },
      { content: '너무 좋아요!!', imageUrl: null, rating: 4, product_id: 51, user_id: 4 },
      { content: '그냥 저냥...', imageUrl: null, rating: 2, product_id: 51, user_id: 4 },
      { content: '별로에요', imageUrl: null, rating: 1, product_id: 51, user_id: 4 },
      { content: '수친 선물로 샀어요', imageUrl: null, rating: 5, product_id: 70, user_id: 3 },
      { content: '수친 선물로 샀어요', imageUrl: null, rating: 5, product_id: 71, user_id: 3 },
      { content: '수친 선물로 샀어요', imageUrl: null, rating: 4, product_id: 71, user_id: 3 },
      { content: '무난템', imageUrl: null, rating: 2, product_id: 71, user_id: 3 },
      { content: '써본 것 중에 제일 좋아요', imageUrl: null, rating: 5, product_id: 80, user_id: 3 },
      { content: '써본 것 중에 제일 좋아요', imageUrl: null, rating: 5, product_id: 81, user_id: 2 },
      { content: '쓸만해요', imageUrl: null, rating: 4, product_id: 81, user_id: 2 },
      { content: '입문자에게 추천!', imageUrl: null, rating: 4, product_id: 90, user_id: 2 },
      { content: '입문자에게 추천!', imageUrl: null, rating: 5, product_id: 91, user_id: 2 },
      { content: 'ㅁㄴ..', imageUrl: null, rating: 3, product_id: 91, user_id: 2 },
    ])
