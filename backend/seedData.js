...
const seedData = async () => {
  try {
    ...
    productData.push(
      {
        ...
        description: `아시안핏으로 출시된 원피스로 꾸준히 사랑받는 베스트셀러 수영복입니다. 유체역학적 설계로 최상의 퍼포먼스를 제공합니다.`,
        price: 99000,
        discountedPrice: 89100,
        size: [`S`, `M`, `L`, `XL`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product1-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product1-02.jpg`,
        ],
        salesVolume: 50,
        category_id: 4,
        discount_id: 2,
    ...
    productData.push(
      {
        ...
        description: `엘리트 수영선수를 위한 프리미엄 원피스 수영복입니다. 편안한 착용감과 함께 최적의 근육 지지력을 제공합니다.`,
        price: 72000,
        discountedPrice: 64800,
        size: [`S`, `M`, `L`, `XL`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product2-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product2-02.jpg`,
        ],
        salesVolume: 200,
        category_id: 5,
        discount_id: 2,
    ...
    productData.push(
      {
        ...
        size: [`S`, `M`, `L`, `XL`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product3-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product3-02.jpg`,
        ],
        salesVolume: 300,
        category_id: 6,
        discount_id: 2,
    ...
    productData.push(
      {
        ...
        size: [`S`, `M`, `L`, `XL`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product4-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product4-02.jpg`,
        ],
        salesVolume: 400,
        category_id: 7,
        discount_id: 2,
    ...
    productData.push(
      {
        ...
        size: [`FREE`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product5-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product5-02.jpg`,
        ],
    ...
    productData.push(
      {
        ...
        description: `전신 수영복으로 최상의 근육 지지와 압박감을 제공합니다. 고급 소재를 사용하여 내구성과 신축성이 뛰어납니다.`,
        price: 36000,
        discountedPrice: 32400,
        size: [`FREE`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product6-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product6-02.jpg`,
        ],
        salesVolume: 10,
        category_id: 9,
        discount_id: 2,
    ...
    productData.push(
      {
        ...
        size: [`S`, `M`, `L`, `XL`],
        imageUrl: [
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product7-01.jpg`,
          `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/product-images/product7-02.jpg`,
        ],
        salesVolume: 20,
    ...
    const reviews = await Review.bulkCreate([
      ...
      {
        content: `만족스러운 구매`,
        imageUrl: `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/review-images/reviews1-01.jpg`,
        rating: 4,
        product_id: 3,
        user_id: 2,
      },
      ...
      {
        content: `이 수영복은 디자인이 예쁘고 착용감도 편안해서 좋아요. 특히, 엉덩이 라인이 예쁘게 잡혀서 만족스럽습니다. 여름 휴가 때 꼭 입고 싶어요!`,
        imageUrl: `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/review-images/reviews1-01.jpg`,
        rating: 4,
        product_id: 20,
        user_id: 2,
      ...
      {
        content: `무난템`,
        imageUrl: `http://${process.env.DB_HOSTNAME}:${process.env.EXPRESS_PORT}/review-images/reviews1-02.jpg`,
        rating: 3,
        product_id: 20,
        user_id: 2,
      },
