...
const seedData = async () => {
  try {
    ...
    const reviews = await Review.bulkCreate([
      ...
      { content: '만족스러운 구매', imageUrl: null, rating: 4, product_id: 3, user_id: 2 },
      ...
      { content: '좋아요', imageUrl: null, rating: 4, product_id: 20, user_id: 2 },
      { content: '무난템', imageUrl: null, rating: 3, product_id: 20, user_id: 2 },
